...
// Determine IP family automatically if not provided
const resolvedFamily =
  family ||
  (address.includes(":") ? 6 : address.includes(".") ? 4 : undefined);
  if (!resolvedFamily) {
    throw new Error("Unable to determine IP family from the address");
  }
