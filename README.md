...
### Using Axios with TypeScript — Custom Instance + Typed Interceptors

This example demonstrates how to create a custom axios instance with fully typed request and response interceptors:
...
// Define a typed interface for your API response
interface User {
  id: number;
  name: string;
  email: string;
...
// Add a typed request interceptor
...
// Add a typed response interceptor
...
// Make a typed API call using generics
