...
description: 'Learn how to set up and run axios'
---

# Getting Started with axios

This guide will help you get axios up and running on your local machine.
...
Need help? Check our [Developer Guide](/guides/developer) or open an issue on [GitHub](https://github.com/yogyam/axios/issues).
